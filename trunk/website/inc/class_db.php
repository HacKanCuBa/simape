...
//    }
    ...
    {  
        if ($ModoRW) {
            parent::__construct(DB_HOST, DB_USUARIO_RW, DB_PASS_RW, DB_NOMBRE);
        } else {
            parent::__construct(DB_HOST, DB_USUARIO_RO, DB_PASS_RO, DB_NOMBRE);
        }
    ...
    {
        if ($this->character_set_name() != constant('DB_CHARSET')) {
            if ($this->set_charset(constant('DB_CHARSET'))) {
                return $this->real_query('SET NAMES ' . constant('DB_CHARSET'));
            } else {
                return FALSE;
            }
        } else {
...
//    }
    ...
    {
        if ($ModoRW) {
            $this->change_user(DB_USUARIO_RW, DB_PASS_RW, DB_NOMBRE);
        } else {
            $this->change_user(DB_USUARIO_RO, DB_PASS_RO, DB_NOMBRE);
        }
