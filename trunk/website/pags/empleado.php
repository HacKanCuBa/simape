                    ...
                    if($db->real_query($query)) {
                        ...
                        foreach ($buscados as $buscado) {
                            foreach ($buscado as $col_o_tbl) {
                                ...
                                . "table_schema = '" . constant('SMP_DB_NAME') 
...
<?php echo page_get_main(); ?>
    ...
    <form style="text-align: center; margin: 0px auto; width: auto;" 
          method="POST" enctype="multipart/form-data" action="<?php echo page_get_url(SMP_LOC_EMPLEADO, 'pagetkn=' . get_get_pagetkn()); ?>" >
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="4" 
                            ...
                            echo constant('SMP_FILE_MAXIMGSIZE'); ?>" /><input name="frm_file" 
